...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $ams = Product::updateOrCreate(['slug' => 'ams'], [
            ...
            'website_url' => 'https://ams.minidigital.dev',
            'demo_url' => 'https://ams.minidigital.dev',
            ...
            'button_url' => 'https://ams.minidigital.dev',
            'display_order' => 1,
            'published_at' => now(),
        ...
        $smart = Product::updateOrCreate(['slug' => 'smart'], [
            ...
            'website_url' => 'https://smart.minidigital.dev',
            'demo_url' => 'https://smart.minidigital.dev',
            ...
            'button_text' => 'Visit Product',
            'button_url' => 'https://smart.minidigital.dev',
            'display_order' => 2,
            'published_at' => now(),
